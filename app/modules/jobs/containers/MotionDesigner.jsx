...
export default class MotionDesigner extends React.Component{
    constructor() {
        super();
    ...
    render() {
        /* META DATA */
        DocHead.setTitle('Talk - Motion Designer');
        /* /META DATA */
        ...
        return(
            <div className='singleJobContainer motionDesigner'>
                <div className='heading'>
                    ...
                    <ReactCSSTransitionGroup
                        ...
                        <p className='hook'><T>common.motionDesigner.title</T></p>
                    </ReactCSSTransitionGroup>
                ...
                <div className='content'>
                    <div className='intro'>
                        <div className='info'>
                            ...
                            <p className='value'><T>common.motionDesigner.intro.l1</T></p>
                        </div>
                        <div className='info'>
                            <p className='title'><T>common.motionDesigner.intro.t5</T></p>
                            <p className='value'><T>common.motionDesigner.intro.l5</T></p>
                        </div>
                        <div className='info'>
                            <p className='title'><T>common.motionDesigner.intro.t4</T></p>
                            <p className='value'><T>common.motionDesigner.intro.l4</T></p>
                        </div>
                        <div className='info'>
                            <p className='title'><T>common.motionDesigner.intro.t6</T></p>
                            <p className='value'><T>common.motionDesigner.intro.l6</T></p>
                        </div>
                        <div className='info'>
                            <p className='title'><T>common.motionDesigner.intro.t3</T></p>
                            <p className='value'><T>common.motionDesigner.intro.l3</T></p>
                        </div>
                        <div className='info'>
                            <p className='title'><T>common.motionDesigner.intro.t7</T></p>
                            <p className='value'><T>common.motionDesigner.intro.l7</T></p>
                        </div>
                        <div className='info'>
                            <p className='title'><T>common.motionDesigner.intro.t2</T></p>
                            <p className='value'><T>common.motionDesigner.intro.l2</T></p>
                        </div>
                    </div>
                    <div className='description'>
                        <h5><T>common.motionDesigner.jobDescMotion.title</T></h5>
                        <h6><T>common.motionDesigner.jobDescMotion.profile.title</T></h6>
                        <ul>
                            <li><T>common.motionDesigner.jobDescMotion.profile.l1</T></li>
                            <li><T>common.motionDesigner.jobDescMotion.profile.l2</T></li>
                            <li><T>common.motionDesigner.jobDescMotion.profile.l3</T></li>
                            <li><T>common.motionDesigner.jobDescMotion.profile.l4</T></li>
                            <li><T>common.motionDesigner.jobDescMotion.profile.l5</T></li>
                            <li><T>common.motionDesigner.jobDescMotion.profile.l6</T></li>
                            <li><T>common.motionDesigner.jobDescMotion.profile.l7</T></li>
                            <li><T>common.motionDesigner.jobDescMotion.profile.l8</T></li>
                            <li><T>common.motionDesigner.jobDescMotion.profile.l9</T></li>
                        </ul>
                        <h6><T>common.motionDesigner.jobDescMotion.bonus.title</T></h6>
                        <ul>
                            <li><T>common.motionDesigner.jobDescMotion.bonus.l1</T></li>
                            <li><T>common.motionDesigner.jobDescMotion.bonus.l2</T></li>
                            <li><T>common.motionDesigner.jobDescMotion.bonus.l3</T></li>
                        </ul>
                        <h6><T>common.motionDesigner.jobDescMotion.responsabilites.title</T></h6>
                        <ul>
                            <li><T>common.motionDesigner.jobDescMotion.responsabilites.l1</T></li>
                            <li><T>common.motionDesigner.jobDescMotion.responsabilites.l2</T></li>
                            <li><T>common.motionDesigner.jobDescMotion.responsabilites.l3</T></li>
                            <li><T>common.motionDesigner.jobDescMotion.responsabilites.l4</T></li>
                            <li><T>common.motionDesigner.jobDescMotion.responsabilites.l5</T></li>
                            <li><T>common.motionDesigner.jobDescMotion.responsabilites.l6</T></li>
                        </ul>
                        <h6><T>common.motionDesigner.jobDescMotion.mandats.title</T></h6>
                        <ul>
                            <li><T>common.motionDesigner.jobDescMotion.mandats.l1</T></li>
                            <li><T>common.motionDesigner.jobDescMotion.mandats.l2</T></li>
                            <li><T>common.motionDesigner.jobDescMotion.mandats.l3</T></li>
                            <li><T>common.motionDesigner.jobDescMotion.mandats.l4</T></li>
                            <li><T>common.motionDesigner.jobDescMotion.mandats.l5</T></li>
                        </ul>
                ...
                <div className='postForm' ref='postForm'>
                    <div className='postWrapper' ref='postContent'>
                        <span className='formTitle'><T>common.motionDesigner.title</T></span>
                        {formError}
                        <form id='postForm'>
                            <div className='row'>
                ...
                <JobNavigation ref='jobNav' changeOffer={this.changeOffer} current='motion-designer' />
