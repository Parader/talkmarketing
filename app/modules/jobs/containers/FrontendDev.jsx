...
export default class FrontEndDev extends React.Component{
    constructor() {
        super();
    ...
    render() {
        /* META DATA */
        DocHead.setTitle('Talk - Front-end Developper');
        /* /META DATA */
        ...
        return(
            <div className='singleJobContainer frontendDev'>
                <div className='heading'>
                    ...
                    <ReactCSSTransitionGroup
                        ...
                        <p className='hook'><T>common.team.jobs.jobDevTitle</T></p>
                    </ReactCSSTransitionGroup>
                ...
                <div className='content'>
                    <div className='intro'>
                        <div className='info'>
                            ...
                            <p className='value'><T>common.frontEnd.intro.l1</T></p>
                        </div>
                        <div className='info'>
                            <p className='title'><T>common.motionDesigner.intro.t5</T></p>
                            <p className='value'><T>common.frontEnd.intro.l5</T></p>
                        </div>
                        <div className='info'>
                            <p className='title'><T>common.motionDesigner.intro.t4</T></p>
                            <p className='value'><T>common.frontEnd.intro.l4</T></p>
                        </div>
                        <div className='info'>
                            <p className='title'><T>common.motionDesigner.intro.t6</T></p>
                            <p className='value'><T>common.frontEnd.intro.l6</T></p>
                        </div>
                        <div className='info'>
                            <p className='title'><T>common.motionDesigner.intro.t3</T></p>
                            <p className='value'><T>common.frontEnd.intro.l3</T></p>
                        </div>
                        <div className='info'>
                            <p className='title'><T>common.motionDesigner.intro.t7</T></p>
                            <p className='value'><T>common.frontEnd.intro.l7</T></p>
                        </div>
                        <div className='info'>
                            <p className='title'><T>common.motionDesigner.intro.t2</T></p>
                            <p className='value'><T>common.frontEnd.intro.l2</T></p>
                        </div>
                    </div>
                    <div className='description'>
                        <h5><T>common.motionDesigner.jobDescMotion.title</T></h5>
                        <h6><T>common.frontEnd.jobDescDev.profile.title</T></h6>
                        <ul>
                            <li><T>common.frontEnd.jobDescDev.profile.l1</T></li>
                            <li><T>common.frontEnd.jobDescDev.profile.l2</T></li>
                            <li><T>common.frontEnd.jobDescDev.profile.l3</T></li>
                            <li><T>common.frontEnd.jobDescDev.profile.l4</T></li>
                            <li><T>common.frontEnd.jobDescDev.profile.l5</T></li>
                            <li><T>common.frontEnd.jobDescDev.profile.l6</T></li>
                            <li><T>common.frontEnd.jobDescDev.profile.l7</T></li>
                            <li><T>common.frontEnd.jobDescDev.profile.l8</T></li>
                            <li><T>common.frontEnd.jobDescDev.profile.l9</T></li>
                            <li><T>common.frontEnd.jobDescDev.profile.l10</T></li>
                            <li><T>common.frontEnd.jobDescDev.profile.l11</T></li>
                        </ul>
                        <h6><T>common.frontEnd.jobDescDev.bonus.title</T></h6>
                        <ul>
                            <li><T>common.frontEnd.jobDescDev.bonus.l1</T></li>
                            <li><T>common.frontEnd.jobDescDev.bonus.l2</T></li>
                            <li><T>common.frontEnd.jobDescDev.bonus.l3</T></li>
                            <li><T>common.frontEnd.jobDescDev.bonus.l4</T></li>
                            <li><T>common.frontEnd.jobDescDev.bonus.l5</T></li>
                        </ul>
                        <h6><T>common.frontEnd.jobDescDev.responsabilites.title</T></h6>
                        <ul>
                            <li><T>common.frontEnd.jobDescDev.responsabilites.l1</T></li>
                            <li><T>common.frontEnd.jobDescDev.responsabilites.l2</T></li>
                            <li><T>common.frontEnd.jobDescDev.responsabilites.l3</T></li>
                            <li><T>common.frontEnd.jobDescDev.responsabilites.l4</T></li>
                            <li><T>common.frontEnd.jobDescDev.responsabilites.l5</T></li>
                            <li><T>common.frontEnd.jobDescDev.responsabilites.l6</T></li>
                        </ul>
                        <h6><T>common.frontEnd.jobDescDev.work.title</T></h6>
                        <p><T>common.frontEnd.jobDescDev.work.l1</T></p>
                ...
                <div className='postForm' ref='postForm'>
                    <div className='postWrapper' ref='postContent'>
                        <span className='formTitle'><T>common.team.jobs.jobDevTitle</T></span>
                        {formError}
                        <form id='postForm'>
                            <div className='row'>
                ...
                <JobNavigation ref='jobNav' changeOffer={this.changeOffer} current='frontendDev' />
